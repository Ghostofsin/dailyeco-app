        ...
        <div className={styles.articleBlock}>
          ...
          <section className={styles.mainArticle}>
            {/* <p className={styles.introParagraph}>
              In the era of the development of computer games, it is difficult
              to imagine the number of specialists working on the final product
              - developers, designers, artists, scriptwriters, producers and
              other specialists. But in addition to the fact that the game needs
              to be invented and developed, it needs to be successfully sold,
              and therefore analyzed.
            </p> */}

            <h2 id="The-Climate-Conundrum-Unpacked">The Climate Conundrum Unpacked</h2>
            ...
            <h2 id="The-Greenhouse-Effect-Demystified">The Greenhouse Effect Demystified</h2>
            <p className={styles.baseParagraph}>
            ...
            <h2 id="How-Climate-Change-Affects-Your-Food">How Climate Change Affects Your Food</h2>
            <p className={styles.baseParagraph}>
            ...
            <div className={styles.quote}>
              <div className={styles.quoteHeader}>
                <div className={styles.quoteLeft}>
                  ...
                  <QuoteAuthor name={"Sir David Attenborough"} position={"British broadcaster, biologist, natural historian, and writer"} imagePath={"/images/article/David.png"}/>
                </div>
            ...
            <h2 id="Good-Bad-Ugly">Fossil Fuels: The Good, the Bad, and the Ugly</h2>
            <p className={styles.baseParagraph}>
            ...
            <h2 id="The-Final-Frontier">The Final Frontier: Uniting for a Cooler Tomorrow</h2>
            <p className={styles.baseParagraph}>
